...
export class DiffBfEqDifWw extends Mission {
  constructor() {
    super(
      MissionType.Common,
      "L'écart entre éclair et feu est égale à celui entre eau et vent (ex: 5 - 2 = 4 - 7)",
  ...
  validate(card1: Card, card2: Card, card3: Card, card4: Card): boolean {
    ...
    return Math.abs(bolt - fire) === Math.abs(water - wind);
  }
}
